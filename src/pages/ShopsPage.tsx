  ...
  return (
    <Page>
      ...
      <PageHeader
        ...
        subtitle="Manage trusted partners and discover new shops"
      >
        <div className="flex items-center gap-4">
          <div className="bg-slate-100/50 p-1 rounded-lg border border-slate-200/50 flex shadow-sm">
            <Button
              variant={view === 'list' ? 'default' : 'ghost'}
              onClick={() => setView('list')}
              className={`flex items-center gap-2 px-4 py-2 rounded-md text-[10px] font-black uppercase tracking-widest transition-all h-8 ${view === 'list' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-600 hover:bg-transparent'
                }`}
            >
            ...
            <Button
              ...
              onClick={() => setView('map')}
              className={`flex items-center gap-2 px-4 py-2 rounded-md text-[10px] font-black uppercase tracking-widest transition-all h-8 ${view === 'map' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-400 hover:text-slate-600 hover:bg-transparent'
                }`}
            >
          ...
          <Button
            ...
            className="rounded-lg font-black text-[10px] uppercase tracking-widest flex items-center gap-2 shadow-lg active:scale-95 transition-all h-10 px-4 bg-blue-600 hover:bg-blue-700 text-white"
          >
